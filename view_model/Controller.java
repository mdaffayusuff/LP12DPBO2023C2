    ...
    public synchronized void keyPressed(KeyEvent e)
    {
        ...
        if(game.isRunning())
        {
            ...
            if((key == KeyEvent.VK_W) || (key == KeyEvent.VK_UP))
            {
                // Move up.
                temp.setVelY(-5);
                if(this.RecentPressed != 'W'){
                    game.setScore(game.getScore() +1);
                }
                this.RecentPressed = 'W';
            }
            if((key == KeyEvent.VK_A) || (key == KeyEvent.VK_LEFT))
            {
                // Move left.
                temp.setVelX(-5);
                if(this.RecentPressed != 'A'){
                    game.setScore(game.getScore() +1);
                }
                this.RecentPressed = 'A';
            }
            if((key == KeyEvent.VK_S) || (key == KeyEvent.VK_DOWN))
            {
                // Move down.
                temp.setVelY(+5);
                if(this.RecentPressed != 'S'){
                    game.setScore(game.getScore() +1);
                }
                this.RecentPressed = 'S';
            }
            if((key == KeyEvent.VK_D) || (key == KeyEvent.VK_RIGHT))
            {
                // Move right.
                temp.setVelX(+5);
                if(this.RecentPressed != 'D'){
                    game.setScore(game.getScore() +1);
                }
                this.RecentPressed = 'D';
            }
        }
    }
